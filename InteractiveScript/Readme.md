...
| [Anterior](https://github.com/rcfdtools/R.GISPython/tree/main/BasicScript) | [:house: Inicio](https://github.com/rcfdtools/R.GISPython/wiki) | [:beginner: Ayuda](https://github.com/rcfdtools/R.GISPython/discussions/7) | [Siguiente](https://github.com/rcfdtools/R.GISPython/tree/main/InteractiveScriptFunction) |
|----------------------------------------------------------------------------|-----------------------------------------------------------------|----------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
