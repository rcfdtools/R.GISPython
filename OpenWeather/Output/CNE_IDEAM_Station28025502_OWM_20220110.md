...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO ALFONSO LOPEZ - [28025502]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station28025502_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=10.43616667,-73.24766667) or [Openstreet Map](https://www.openstreetmap.org/query?lat=10.43616667&lon=-73.24766667)


| Parameter | Value |
|---|---|
| Code | 28025502 |
| Name | AEROPUERTO ALFONSO LOPEZ - [28025502] |
| Latitude, ° | 10.43616667 |
| Longitude, ° | -73.24766667 |
| Elevation, m | 138 |
| Category | Sinóptica Principal |
| Technology | Automática con Telemetría |
| Status | Activa |
| Installation date | 2016-06-30 19:00:00 |
| Suspension date | NaT |
| State | Cesar |
| County | Valledupar |
| Stream | 0 |
...
### 4133 - Open Weather values for station 000028025502: AEROPUERTO ALFONSO LOPEZ - [28025502]
