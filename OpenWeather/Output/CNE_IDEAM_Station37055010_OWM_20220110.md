...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO SANTIAGO PÉREZ [37055010]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station37055010_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=7.06944444,-70.73805556) or [Openstreet Map](https://www.openstreetmap.org/query?lat=7.06944444&lon=-70.73805556)


| Parameter | Value |
|---|---|
| Code | 37055010 |
| Name | AEROPUERTO SANTIAGO PÉREZ [37055010] |
| Latitude, ° | 7.06944444 |
| Longitude, ° | -70.73805556 |
| Elevation, m | 128 |
| Category | Sinóptica Principal |
| Technology | Convencional |
| Status | Activa |
| Installation date | 1950-05-14 19:00:00 |
| Suspension date | NaT |
| State | Arauca |
| County | Arauca |
| Stream | 0 |
...
### 3116 - Open Weather values for station 000037055010: AEROPUERTO SANTIAGO PÉREZ [37055010]
