...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO VANGUARDIA [35035020]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station35035020_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=4.16191944,-73.61757778) or [Openstreet Map](https://www.openstreetmap.org/query?lat=4.16191944&lon=-73.61757778)


| Parameter | Value |
|---|---|
| Code | 35035020 |
| Name | AEROPUERTO VANGUARDIA [35035020] |
| Latitude, ° | 4.16191944 |
| Longitude, ° | -73.61757778 |
| Elevation, m | 422 |
| Category | Sinóptica Principal |
| Technology | Convencional |
| Status | Activa |
| Installation date | 1924-10-15 00:00:00 |
| Suspension date | NaT |
| State | Meta |
...
### 260 - Open Weather values for station 000035035020: AEROPUERTO VANGUARDIA [35035020]
