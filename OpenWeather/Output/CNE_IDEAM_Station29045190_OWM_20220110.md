...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO E. CORTISSOZ - AUT [29045190]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station29045190_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=10.91777778,-74.77972222) or [Openstreet Map](https://www.openstreetmap.org/query?lat=10.91777778&lon=-74.77972222)


| Parameter | Value |
|---|---|
| Code | 29045190 |
| Name | AEROPUERTO E. CORTISSOZ - AUT [29045190] |
| Latitude, ° | 10.91777778 |
| Longitude, ° | -74.77972222 |
| Elevation, m | 14 |
| Category | Sinóptica Principal |
| Technology | Automática con Telemetría |
| Status | Activa |
| Installation date | 2005-05-04 00:00:00 |
| Suspension date | NaT |
| State | Atlantico |
| County | Soledad |
| Stream | Rancheria |
...
### 492 - Open Weather values for station 000029045190: AEROPUERTO E. CORTISSOZ - AUT [29045190]
