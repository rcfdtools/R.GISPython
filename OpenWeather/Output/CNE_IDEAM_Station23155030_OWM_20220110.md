...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO YARIGUIES [23155030]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station23155030_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=7.02638889,-73.80861111) or [Openstreet Map](https://www.openstreetmap.org/query?lat=7.02638889&lon=-73.80861111)


| Parameter | Value |
|---|---|
| Code | 23155030 |
| Name | AEROPUERTO YARIGUIES [23155030] |
| Latitude, ° | 7.02638889 |
| Longitude, ° | -73.80861111 |
| Elevation, m | 126 |
| Category | Sinóptica Principal |
| Technology | Convencional |
| Status | Activa |
| Installation date | 1931-07-15 00:00:00 |
| Suspension date | NaT |
| State | Santander |
| County | Barrancabermeja |
| Stream | Orinoco |
| Operator | Area Operativa 08 - Santanderes-Arauca |
| AH - Hydrographic area | Magdalena Cauca |
| ZH - Hydrographic zone | Medio Magdalena |
| SZH - Hydrographic subzone | Río Opón |
...
### 264 - Open Weather values for station 000023155030: AEROPUERTO YARIGUIES [23155030]
