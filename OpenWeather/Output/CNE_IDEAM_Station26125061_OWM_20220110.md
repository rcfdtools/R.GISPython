...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO EL EDEN - - AUT [26125061]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station26125061_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=4.45472222,-75.76638889) or [Openstreet Map](https://www.openstreetmap.org/query?lat=4.45472222&lon=-75.76638889)


| Parameter | Value |
|---|---|
| Code | 26125061 |
| Name | AEROPUERTO EL EDEN - - AUT [26125061] |
| Latitude, ° | 4.45472222 |
...
| Status | Activa |
| Installation date | 2016-07-15 00:00:00 |
| Suspension date | NaT |
| State | Quindío |
| County | Armenia (Quindío) |
| Stream | Quebrada Sardinata |
...
### 1075 - Open Weather values for station 000026125061: AEROPUERTO EL EDEN - - AUT [26125061]
