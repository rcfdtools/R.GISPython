...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO A BONILLA [26075040]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station26075040_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=3.53668889,-76.38663889) or [Openstreet Map](https://www.openstreetmap.org/query?lat=3.53668889&lon=-76.38663889)


| Parameter | Value |
|---|---|
| Code | 26075040 |
| Name | AEROPUERTO A BONILLA [26075040] |
| Latitude, ° | 3.53668889 |
| Longitude, ° | -76.38663889 |
| Elevation, m | 970 |
| Category | Sinóptica Principal |
| Technology | Automática con Telemetría |
| Status | Activa |
| Installation date | 1971-07-15 00:00:00 |
| Suspension date | NaT |
...
### 259 - Open Weather values for station 000026075040: AEROPUERTO A BONILLA [26075040]
