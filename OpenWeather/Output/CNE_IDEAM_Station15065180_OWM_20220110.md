...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO ALM. PADILLA - [15065180]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station15065180_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=11.52961111,-72.91766667) or [Openstreet Map](https://www.openstreetmap.org/query?lat=11.52961111&lon=-72.91766667)


| Parameter | Value |
|---|---|
| Code | 15065180 |
| Name | AEROPUERTO ALM. PADILLA - [15065180] |
| Latitude, ° | 11.52961111 |
| Longitude, ° | -72.91766667 |
| Elevation, m | 4 |
| Category | Sinóptica Principal |
| Technology | Automática con Telemetría |
| Status | Activa |
| Installation date | 2004-06-21 00:00:00 |
| Suspension date | NaT |
| State | La Guajira |
| County | Riohacha |
| Stream | Cno Cicuco |
...
### 2657 - Open Weather values for station 000015065180: AEROPUERTO ALM. PADILLA - [15065180]
