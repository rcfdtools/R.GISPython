...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO ANTONIO NARINO [52045020]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station52045020_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=1.39408333,-77.29086111) or [Openstreet Map](https://www.openstreetmap.org/query?lat=1.39408333&lon=-77.29086111)


| Parameter | Value |
|---|---|
| Code | 52045020 |
| Name | AEROPUERTO ANTONIO NARINO [52045020] |
| Latitude, ° | 1.39408333 |
| Longitude, ° | -77.29086111 |
| Elevation, m | 1796 |
| Category | Sinóptica Principal |
| Technology | Convencional |
| Status | Activa |
| Installation date | 1957-11-15 00:00:00 |
| Suspension date | NaT |
| State | Nariño |
| County | Chachaguí |
| Stream | Amazonas |
...
### 257 - Open Weather values for station 000052045020: AEROPUERTO ANTONIO NARINO [52045020]
