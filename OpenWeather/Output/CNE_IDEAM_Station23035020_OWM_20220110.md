...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO PALANQUERO [23035020]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station23035020_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=5.47138889,-74.65472222) or [Openstreet Map](https://www.openstreetmap.org/query?lat=5.47138889&lon=-74.65472222)


| Parameter | Value |
|---|---|
| Code | 23035020 |
| Name | AEROPUERTO PALANQUERO [23035020] |
| Latitude, ° | 5.47138889 |
| Longitude, ° | -74.65472222 |
| Elevation, m | 172 |
| Category | Sinóptica Principal |
| Technology | Convencional |
| Status | Activa |
| Installation date | 1957-01-15 00:00:00 |
| Suspension date | NaT |
| State | Cundinamarca |
...
### 1575 - Open Weather values for station 000023035020: AEROPUERTO PALANQUERO [23035020]
