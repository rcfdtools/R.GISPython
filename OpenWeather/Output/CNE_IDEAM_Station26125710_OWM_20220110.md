...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO MATECANA [26125710]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station26125710_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=4.812675,-75.73951944) or [Openstreet Map](https://www.openstreetmap.org/query?lat=4.812675&lon=-75.73951944)


| Parameter | Value |
|---|---|
| Code | 26125710 |
| Name | AEROPUERTO MATECANA [26125710] |
| Latitude, ° | 4.812675 |
| Longitude, ° | -75.73951944 |
| Elevation, m | 1342 |
| Category | Sinóptica Principal |
| Technology | Automática con Telemetría |
| Status | Activa |
| Installation date | 2014-09-12 00:00:00 |
| Suspension date | NaT |
| State | RIsaralda |
| County | Pereira |
| Stream | Recio |
...
### 1952 - Open Weather values for station 000026125710: AEROPUERTO MATECANA [26125710]
