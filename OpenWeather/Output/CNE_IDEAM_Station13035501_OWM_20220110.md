...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO LOS GARZONES [13035501]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station13035501_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=8.82583333,-75.82513889) or [Openstreet Map](https://www.openstreetmap.org/query?lat=8.82583333&lon=-75.82513889)


| Parameter | Value |
|---|---|
| Code | 13035501 |
| Name | AEROPUERTO LOS GARZONES [13035501] |
| Latitude, ° | 8.82583333 |
| Longitude, ° | -75.82513889 |
| Elevation, m | 20 |
| Category | Sinóptica Principal |
| Technology | Automática con Telemetría |
| Status | Activa |
| Installation date | 2015-02-06 00:00:00 |
| Suspension date | NaT |
| State | Córdoba |
| County | Montería |
| Stream | Cno Tapoa |
...
### 3315 - Open Weather values for station 000013035501: AEROPUERTO LOS GARZONES [13035501]
