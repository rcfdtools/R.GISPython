...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO CAMILO DAZA [16015010]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station16015010_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=7.93027778,-72.50916667) or [Openstreet Map](https://www.openstreetmap.org/query?lat=7.93027778&lon=-72.50916667)


| Parameter | Value |
|---|---|
| Code | 16015010 |
| Name | AEROPUERTO CAMILO DAZA [16015010] |
| Latitude, ° | 7.93027778 |
| Longitude, ° | -72.50916667 |
| Elevation, m | 250 |
| Category | Sinóptica Principal |
| Technology | Convencional |
| Status | Activa |
| Installation date | 1941-02-15 00:00:00 |
| Suspension date | NaT |
...
### 266 - Open Weather values for station 000016015010: AEROPUERTO CAMILO DAZA [16015010]
