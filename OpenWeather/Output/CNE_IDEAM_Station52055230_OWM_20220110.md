...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO SAN LUIS - AUT [52055230]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station52055230_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=0.85708333,-77.67775) or [Openstreet Map](https://www.openstreetmap.org/query?lat=0.85708333&lon=-77.67775)


| Parameter | Value |
|---|---|
| Code | 52055230 |
| Name | AEROPUERTO SAN LUIS - AUT [52055230] |
| Latitude, ° | 0.85708333 |
| Longitude, ° | -77.67775 |
| Elevation, m | 2961 |
...
| Status | Activa |
| Installation date | 1997-11-06 00:00:00 |
| Suspension date | NaT |
| State | Nariño |
| County | Aldana |
| Stream | Vaupes |
...
### 2563 - Open Weather values for station 000052055230: AEROPUERTO SAN LUIS - AUT [52055230]
