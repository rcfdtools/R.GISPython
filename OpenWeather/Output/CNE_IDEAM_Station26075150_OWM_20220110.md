...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO A.BONILLA - AUT [26075150]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station26075150_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=3.53299167,-76.3825) or [Openstreet Map](https://www.openstreetmap.org/query?lat=3.53299167&lon=-76.3825)


| Parameter | Value |
|---|---|
| Code | 26075150 |
| Name | AEROPUERTO A.BONILLA - AUT [26075150] |
| Latitude, ° | 3.53299167 |
| Longitude, ° | -76.3825 |
| Elevation, m | 961 |
...
| Status | Activa |
| Installation date | 2005-09-26 00:00:00 |
| Suspension date | NaT |
...
### 2316 - Open Weather values for station 000026075150: AEROPUERTO A.BONILLA - AUT [26075150]
