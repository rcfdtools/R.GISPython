...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO PALONEGRO [23195502]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station23195502_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=7.12147222,-73.18452778) or [Openstreet Map](https://www.openstreetmap.org/query?lat=7.12147222&lon=-73.18452778)


| Parameter | Value |
|---|---|
| Code | 23195502 |
| Name | AEROPUERTO PALONEGRO [23195502] |
| Latitude, ° | 7.12147222 |
| Longitude, ° | -73.18452778 |
| Elevation, m | 1189 |
| Category | Sinóptica Principal |
| Technology | Automática con Telemetría |
| Status | Activa |
| Installation date | 2005-05-05 00:00:00 |
| Suspension date | NaT |
| State | Santander |
| County | Lebrija |
...
### 3343 - Open Weather values for station 000023195502: AEROPUERTO PALONEGRO [23195502]
