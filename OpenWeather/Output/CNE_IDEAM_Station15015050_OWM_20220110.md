...
## Weather values for the IDEAM national station catalog - CNE from OWM https://openweathermap.org - AEROPUERTO SIMON BOLIVAR [15015050]
...
* Related files: [Station Markdown, ](https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_Station15015050_OWM_20220110.md)[General CSV]( https://github.com/rcfdtools/R.GISPython/blob/main/OpenWeather/Output/CNE_IDEAM_OWM_20220110.csv)


#### Station parameters and location over [Google Maps](http://maps.google.com/maps?q=11.12833333,-74.22888889) or [Openstreet Map](https://www.openstreetmap.org/query?lat=11.12833333&lon=-74.22888889)


| Parameter | Value |
|---|---|
| Code | 15015050 |
| Name | AEROPUERTO SIMON BOLIVAR [15015050] |
| Latitude, ° | 11.12833333 |
| Longitude, ° | -74.22888889 |
| Elevation, m | 4 |
| Category | Sinóptica Principal |
| Technology | Convencional |
| Status | Activa |
| Installation date | 1952-06-15 00:00:00 |
| Suspension date | NaT |
| State | Magdalena |
| County | Santa Marta |
| Stream | Tabaco El |
...
### 666 - Open Weather values for station 000015015050: AEROPUERTO SIMON BOLIVAR [15015050]
