...
Para la instalación en Python 3.10 de la librería oficial de `pandas`, desde el `CMD` de Microsoft Windows ejecutar las siguientes instrucciones del administrador de paquetes `pip` o desde las opciones de configuración de PyCharm, realice la instalación desde el intérprete de comandos asociado al proyecto. [Más información acerca de como instalar paquetes.](https://github.com/rcfdtools/R.GISPython/tree/main/InstallPackageGraph).
