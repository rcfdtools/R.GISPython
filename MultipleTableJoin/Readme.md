...
* `stations_file`: [Stations.csv](Stations.csv) contains a list of the stations to bo joined. The parameter `process_all = False` has to be established in False, otherwise, all the files founded in the Input folder will be joined. For this example, Stations.csv contains all the Amazonas basin stations.
