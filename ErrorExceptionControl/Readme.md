...
| [Anterior](https://github.com/rcfdtools/R.GISPython/tree/main/InstallPackageGraph)  | [:house: Inicio](https://github.com/rcfdtools/R.GISPython/wiki) | [:beginner: Ayuda](https://github.com/rcfdtools/R.GISPython/discussions/10) | [Siguiente](https://github.com/rcfdtools/R.GISPython/tree/main/LogScript)    |
|-------------------------------------------------------------------------------------|-----------------------------------------------------------------|-----------------------------------------------------------------------------|------------------------------------------------------------------------------|
